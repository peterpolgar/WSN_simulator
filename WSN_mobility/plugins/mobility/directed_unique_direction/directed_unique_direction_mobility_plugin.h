...
class cDirected_unique_direction_mobility : public QObject, iMobility_interface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "mobility.interface" FILE "directed_unique_direction.json")
