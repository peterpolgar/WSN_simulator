...
QString cDirected_unique_direction_mobility::Alg_name()
{
    return "Directed unique-direction";
}

bool cDirected_unique_direction_mobility::Is_for_sinks()
{
    return true;
}

bool cDirected_unique_direction_mobility::Is_for_nodes()
{
    return false;
}

void cDirected_unique_direction_mobility::Get_client_params(std::vector<double> *set_pos_vec, int *number_of_set_items, const std::vector<double> *get_pos_vec,
...
void cDirected_unique_direction_mobility::Get_widgets(std::vector<QWidget*> widgets)
{
...
void cDirected_unique_direction_mobility::Unit_len_changed()
{
...
void cDirected_unique_direction_mobility::Resize_happened(double new_old_rate)
{
//    col_avoid_radius_square = (col_avoid_meter_radius / *area_m_width) * *area_m_width;
//    col_avoid_radius_basic = col_avoid_radius_square;
//    col_avoid_radius_square *= col_avoid_radius_square;
...
std::vector<cDirected_unique_direction_mobility::sParam>* cDirected_unique_direction_mobility::Get_parameters()
{
    auto vec = new std::vector<cDirected_unique_direction_mobility::sParam>();
...
void cDirected_unique_direction_mobility::Set_parameter(int param_id, double value_or_index)
{
    switch ( param_id ) {
...
QString cDirected_unique_direction_mobility::Get_params_string()
{
    QString x("");
