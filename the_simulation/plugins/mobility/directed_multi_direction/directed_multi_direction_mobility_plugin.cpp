...
extern "C" EXPORT iMobility_interface* getObj(void) {
    return (iMobility_interface*)(new cDirected_multi_direction_mobility);
}
...
std::string cDirected_multi_direction_mobility::Alg_name()
{
    return "Directed multi-direction";
}

void cDirected_multi_direction_mobility::Get_client_params(std::vector<double> *set_pos_vec, unsigned *number_of_set_items, const std::vector<double> *get_pos_vec,
...
std::string cDirected_multi_direction_mobility::Get_params_string()
{
    std::string x("");
